[![Java CI with Maven](https://github.com/Suparnaen/ShoppingWebTest/actions/workflows/maven.yml)](https://github.com/Suparnaen/ShoppingWebTest/actions/workflows/maven.yml)
